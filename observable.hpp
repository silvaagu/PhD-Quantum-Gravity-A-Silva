...
protected:
	...
	static std::vector<Vertex::Label> ball(Vertex::Label origin, int radius);
	static std::vector<Triangle::Label> sphereDual(Triangle::Label origin, int radius);
	static std::vector<Triangle::Label> ballDual(Triangle::Label origin, int radius);
	...
	std::string data_dir = "example/out/";
